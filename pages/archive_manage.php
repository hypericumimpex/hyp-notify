             ...
             <table class="wp-list-table widefat fixed tags" cellspacing="0" <?php if(get_bloginfo('version') < 3.8){?>style="table-layout: auto"<?php }?>>
                <thead>
                   <tr>
                      ...
                      <th scope="col" class="manage-column" style="width:50px"><span><?php echo __('ID', 'smpush-plugin-lang')?></span></th>
                ...
                <?php if($archives){$counter = 0;foreach($archives AS $archive){$counter++;?>
                   <tr id="smpush-service-tab-<?php echo $archive->id;?>" class="smpush-service-tab <?php if($counter%2 == 0){echo 'alternate';}?>">
                      ...
                      <td class="name column-name"><span title="<?php echo str_replace('"', '`', $archive->name);?>"><?php echo self::ShortString($archive->name, 200);?></span></td>
                      ...
                      <td class="name column-name smpush-center">
                        ...
                        <?php echo '--'?>
                        <?php else: echo gmdate(self::$wpdateformat, strtotime($archive->starttime));?>
                        <?php endif;?>
                      </td>
                      <td class="name column-name smpush-center">
                        <?php if($archive->send_type == 'feedback' || $archive->send_type == 'template'):?>
                        ...
                        <?php else: echo gmdate(self::$wpdateformat, strtotime($archive->endtime));?>
                        <?php endif;?>
                      </td>
                      <td class="name column-name smpush-center">
                      ...
                      <td class="description column-categories">
                        ...
                        <a href="<?php echo $pageurl?>&action=edit&id=<?php echo $archive->id;?>" class="button action"><?php echo __('Edit', 'smpush-plugin-lang')?></a>
                        <?php endif;?>
                ...
                <?php }}else{?>
                <tr class="no-items"><td class="colspanchange smpush-center" colspan="10"><?php echo __('No items found.', 'smpush-plugin-lang')?></td></tr>
                <?php }?>
                </tbody>
             </table>
