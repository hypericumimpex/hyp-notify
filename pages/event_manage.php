             ...
             <table class="wp-list-table widefat fixed tags" cellspacing="0">
                <thead>
                   <tr>
                      ...
                      <th scope="col" class="manage-column smpush-center smpush-canhide"><span><?php echo __('Event Type', 'smpush-plugin-lang')?></span></th>
                      ...
                      <th scope="col" class="manage-column column-categories smpush-canhide" style="width:100px"><span></span></th>
                ...
                <tfoot>
                   <tr>
                      ...
                      <th scope="col" class="manage-column smpush-center smpush-canhide"><span><?php echo __('Post Type', 'smpush-plugin-lang')?></span></th>
                      <th scope="col" class="manage-column smpush-center smpush-canhide"><span><?php echo __('Status', 'smpush-plugin-lang')?></span></th>
                      <th scope="col" class="manage-column column-categories smpush-canhide"><span></span></th>
                      <th scope="col"></th>
                   </tr>
                </tfoot>
                ...
                <?php if($events){$counter = 0;foreach($events AS $event){$counter++;?>
                   <tr id="smpush-service-tab-<?php echo $event->id;?>" class="smpush-service-tab <?php if($counter%2 == 0){echo 'alternate';}?>">
                      ...
                      <td class="description column-description smpush-center smpush-canhide"><?php echo $event->event_type;?></td>
                      ...
                      <td class="description column-categories smpush-canhide">
